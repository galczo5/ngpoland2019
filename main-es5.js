(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(viewContainerRef, inboxService) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InboxHttpClient = /** @class */ (function () {
                function InboxHttpClient() {
                }
                InboxHttpClient.prototype.get = function (url) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InboxService = /** @class */ (function () {
                function InboxService(httpClient) {
                    this.httpClient = httpClient;
                }
                InboxService.prototype.fetch = function () {
                ...
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
                    ...
                    providers: [
                        // CODE EXAMPLE BELOW
                        {
                            ...
                            useFactory: function (resolver) {
                                return function (cRef) {
                                    var factory = resolver.resolveComponentFactory(_modal_gdpr_modal_component__WEBPACK_IMPORTED_MODULE_3__["GdprModalComponent"]);
                                    var viewContainerRef = cRef.injector.get(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"]);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var GdprModalComponent = /** @class */ (function () {
                function GdprModalComponent() {
                    this.modalVisible = true;
                }
                GdprModalComponent.prototype.close = function () {
                    this.modalVisible = false;
                };
                return GdprModalComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserSettingsModalService = /** @class */ (function () {
                function UserSettingsModalService(factoryResolver) {
                    this.factoryResolver = factoryResolver;
                    this.instance = null;
                }
                UserSettingsModalService.prototype.open = function (viewContainerRef) {
                    if (this.instance !== null) {
                        console.error('User settings modal already opened');
                        return;
                    }
                    var factory = this.factoryResolver.resolveComponentFactory(_user_settings_user_settings_component__WEBPACK_IMPORTED_MODULE_2__["UserSettingsComponent"]);
                    this.instance = viewContainerRef.createComponent(factory);
                };
                UserSettingsModalService.prototype.close = function () {
                    if (this.instance === null) {
                ...
                return UserSettingsModalService;
            }());
            UserSettingsModalService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserSettingsComponent = /** @class */ (function () {
                function UserSettingsComponent(modalService, storeService) {
                ...
                UserSettingsComponent.prototype.setWidget = function (widget) {
                    localStorage.setItem('widget', widget);
                };
                UserSettingsComponent.prototype.saveChanges = function () {
                    location.reload();
                };
                UserSettingsComponent.prototype.close = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                function HeaderComponent(viewContainerRef, modalService) {
                    this.viewContainerRef = viewContainerRef;
                    this.modalService = modalService;
                }
                HeaderComponent.prototype.openConfiguartion = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var platformRef = Object(_angular_platform_browser_dynamic__WEBPACK_IMPORTED_MODULE_3__["platformBrowserDynamic"])([
                ...
                // CODE EXAMPLE BELOW
                {
                    ...
                    useFactory: function (applicationPropertiesService, settingsService, settingsStoreService) {
                        return function () {
                            var applicationProperties$ = applicationPropertiesService.get();
                            applicationProperties$.subscribe(function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var ApplicationPropertiesService = /** @class */ (function () {
                function ApplicationPropertiesService() {
                }
                ApplicationPropertiesService.prototype.get = function () {
                    var properties = {
                        restUrl: ''
                    };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserSettingsStoreService = /** @class */ (function () {
                function UserSettingsStoreService() {
                    this.state = _widget__WEBPACK_IMPORTED_MODULE_2__["Widget"].NEWS;
                }
                UserSettingsStoreService.prototype.setWidget = function (type) {
                    this.state = type;
                };
                UserSettingsStoreService.prototype.getWidget = function () {
                    return this.state;
                };
                return UserSettingsStoreService;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserSettingsService = /** @class */ (function () {
                ...
                UserSettingsService.prototype.get = function () {
                    var item = localStorage.getItem('widget');
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])({
            ...
            (function () {
                ...
                document.addEventListener('keydown', function (event) {
                    if (event.key.toLowerCase() === '1') {
                        apps.forEach(function (x) { return showApplicationAreas(x); });
                    }
                    if (event.key.toLowerCase() === '2') {
                        apps.forEach(function (x) { return hideApplicationAreas(x); });
                    }
                });
            })();
            /***/ 
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ActivitiesListComponent = /** @class */ (function () {
                function ActivitiesListComponent(activitiesService) {
                ...
                ActivitiesListComponent.prototype.ngOnInit = function () {
                    ...
                    this.activitiesService.get()
                        ...
                        _this.fetchDate = new Date();
                        _this.activities = activities;
                        _this.activities.sort(function (a, b) { return b.date.getTime() - a.date.getTime(); });
                        _this.closedActivities = _this.activities.slice(0, 2);
                    });
                };
                    ...
                    providers: [
                        {
                            ...
                            useFactory: function (activitiesService) {
                                return function () { return activitiesService.startFetching(); };
                            },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ActivitiesService = /** @class */ (function () {
                function ActivitiesService(httpClient) {
                    this.httpClient = httpClient;
                    this.activities$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["ReplaySubject"]();
                }
                ActivitiesService.prototype.startFetching = function () {
                    var _this = this;
                    Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(2000)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function () { return _this.httpClient.get(''); }))
                        .subscribe(function (activities) {
                        _this.activities$.next(activities);
                    });
                };
                ActivitiesService.prototype.get = function () {
                    return this.activities$.asObservable();
                };
                return ActivitiesService;
            }());
            ActivitiesService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ActivityWidgetComponent = /** @class */ (function () {
                function ActivityWidgetComponent() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var ActivitiesHttpClient = /** @class */ (function () {
                function ActivitiesHttpClient() {
                }
                ActivitiesHttpClient.prototype.get = function (url) {
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])([{
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
            var NewsHttpClient = /** @class */ (function () {
                function NewsHttpClient() {
                }
                NewsHttpClient.prototype.get = function (url) {
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])([{
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewsListComponent = /** @class */ (function () {
                function NewsListComponent(service) {
            ...
            NewsListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var NewsWidgetComponent = /** @class */ (function () {
                function NewsWidgetComponent() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewsService = /** @class */ (function () {
                ...
                NewsService.prototype.startFetching = function () {
                    var _this = this;
                    Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(2000)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function () { return _this.httpClient.get(''); }))
                        .subscribe(function (news) {
                        _this.news$.next(news);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WidgetsModule = /** @class */ (function () {
                function WidgetsModule(storeService) {
                    this.storeService = storeService;
                }
                // CODE EXAMPLE BELOW
                WidgetsModule.prototype.ngDoBootstrap = function (appRef) {
                    var widget = this.storeService.getWidget();
            ...
            WidgetsModule.ctorParameters = function () { return [
